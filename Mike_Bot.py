...
while True:
    ...
    for ship in me.get_ships():
        ...
        dropoff_options = me.get_dropoffs()

        logging.info(dropoff_options)
        ...
        if ship_states[ship.id] == "depositing":
            ...
            if game.turn_number <= 200 and ship.halite_amount > constants.MAX_HALITE * 0.99:
...
# Don't spawn a ship if you currently have a ship at port, though - the ships will collide.
    ...
    if len(me.get_ships()) <= 25 and game.turn_number <= 200 and me.halite_amount >= constants.SHIP_COST and not game_map[me.shipyard].is_occupied:

        command_queue.append(me.shipyard.spawn())

    if game.turn_number == 250 and me.halite_amount >= constants.DROPOFF_COST and not game_map[me.shipyard].is_occupied:
